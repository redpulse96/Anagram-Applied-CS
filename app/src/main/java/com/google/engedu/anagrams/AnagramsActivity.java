...
public class AnagramsActivity extends AppCompatActivity {
    ...
    public static final String START_MESSAGE = "<h3>Find as many words as possible that can be formed by adding one letter to \"<big>%s</big>\" (but that do not contain the substring %s).</h3>";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            dictionary = new AnagramDictionary(new InputStreamReader(inputStream));//InputStreamReader is used to read and convert from bytes to characters
        } catch (IOException e) {
